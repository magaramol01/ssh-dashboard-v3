  ...
  <Card class="shadow-xs flex flex-col h-full min-h-[420px]">
    ...
    <CardContent class="p-4 flex-1 flex flex-col justify-between">
      ...
      <div v-if="activeTab === 'propulsion'" class="grid grid-cols-2 gap-3 flex-1 items-center">
        ...
        <div class="flex flex-col items-center justify-between rounded-lg border bg-card/60 p-3 h-full shadow-xs">
          <div class="w-full flex items-center justify-between text-xs text-muted-foreground">
            <span class="font-medium uppercase text-[10px]">Speed (SOG)</span>
            <span class="text-primary font-mono font-bold text-[10px]">kn</span>
          </div>
          ...
          <div class="relative flex items-center justify-center my-1">
            ...
            <div class="absolute bottom-1 flex flex-col items-center">
              <span class="font-mono text-lg font-bold text-foreground tabular-nums">{{ speedVal.toFixed(1) }}</span>
              <span class="text-[9px] text-muted-foreground uppercase tracking-wider">KNOTS</span>
            </div>
          </div>

          <div class="w-full pt-1.5 border-t border-border flex items-center justify-between text-[11px] text-muted-foreground">
            <span>STW: <b class="text-foreground font-mono">{{ stwVal.toFixed(1) }} kn</b></span>
            <span class="text-emerald-500 font-medium text-[10px]">Optimal</span>
          </div>
        </div>
        ...
        <div class="flex flex-col items-center justify-between rounded-lg border bg-card/60 p-3 h-full shadow-xs">
          <div class="w-full flex items-center justify-between text-xs text-muted-foreground">
            <span class="font-medium uppercase text-[10px]">Engine Load</span>
            <span class="text-primary font-mono font-bold text-[10px]">% MCR</span>
          </div>
          ...
          <div class="relative flex items-center justify-center my-1">
            ...
            <div class="absolute bottom-1 flex flex-col items-center">
              <span class="font-mono text-lg font-bold text-foreground tabular-nums">{{ mcrVal.toFixed(1) }}%</span>
              <span class="text-[9px] text-muted-foreground uppercase tracking-wider">RATED MCR</span>
            </div>
          </div>

          <div class="w-full pt-1.5 border-t border-border flex items-center justify-between text-[11px] text-muted-foreground">
            <span>Zone: <b class="text-foreground">Continuous</b></span>
            <span class="font-mono text-[10px]">Limit: 95%</span>
          </div>
        </div>
        ...
        <div class="flex flex-col items-center justify-between rounded-lg border bg-card/60 p-3 h-full shadow-xs">
          <div class="w-full flex items-center justify-between text-xs text-muted-foreground">
            <span class="font-medium uppercase text-[10px]">Shaft RPM</span>
            <span class="text-muted-foreground font-mono text-[10px]">0-120</span>
          </div>
          ...
          <div class="relative flex items-center justify-center my-1">
            ...
            <div class="absolute bottom-1 flex flex-col items-center">
              <span class="font-mono text-lg font-bold text-foreground tabular-nums">{{ rpmVal.toFixed(1) }}</span>
              <span class="text-[9px] text-muted-foreground uppercase tracking-wider">REV / MIN</span>
            </div>
          </div>

          <div class="w-full pt-1.5 border-t border-border flex items-center justify-between text-[11px] text-muted-foreground">
            <span>Torque: <b class="text-foreground font-mono">{{ torqueVal }} kNm</b></span>
            <span class="text-[10px]">Nominal</span>
          </div>
        </div>
        ...
        <div class="flex flex-col items-center justify-between rounded-lg border bg-card/60 p-3 h-full shadow-xs">
          <div class="w-full flex items-center justify-between text-xs text-muted-foreground">
            <span class="font-medium uppercase text-[10px]">Fuel Rate</span>
            <span class="text-primary font-mono font-bold text-[10px]">t/day</span>
          </div>
          ...
          <div class="relative flex items-center justify-center my-1">
            ...
            <div class="absolute bottom-1 flex flex-col items-center">
              <span class="font-mono text-lg font-bold text-foreground tabular-nums">{{ fuelVal.toFixed(1) }}</span>
              <span class="text-[9px] text-muted-foreground uppercase tracking-wider">TONS / DAY</span>
            </div>
          </div>

          <div class="w-full pt-1.5 border-t border-border flex items-center justify-between text-[11px] text-muted-foreground">
            <span>SFOC: <b class="text-foreground font-mono">168.4 g/kWh</b></span>
            <span class="text-[10px]">Economic</span>
          </div>
        </div>
      </div>
      ...
      <div v-else class="grid grid-cols-2 gap-3 flex-1 items-center">
        ...
        <div class="flex flex-col items-center justify-between rounded-lg border bg-card/60 p-3 h-full shadow-xs">
          <div class="w-full flex items-center justify-between text-xs text-muted-foreground">
            <span class="font-medium uppercase text-[10px]">Rel. Wind Speed</span>
            <span class="text-primary font-mono font-bold text-[10px]">kn</span>
          </div>
          ...
          <div class="relative flex items-center justify-center my-1">
            ...
            <div class="absolute bottom-1 flex flex-col items-center">
              <span class="font-mono text-lg font-bold text-foreground tabular-nums">{{ windSpeed.toFixed(1) }}</span>
              <span class="text-[9px] text-muted-foreground uppercase tracking-wider">KNOTS</span>
            </div>
          </div>
        ...
        <div class="flex flex-col items-center justify-between rounded-lg border bg-card/60 p-3 h-full shadow-xs">
          <div class="w-full flex items-center justify-between text-xs text-muted-foreground">
            <span class="font-medium uppercase text-[10px]">Wind Direction</span>
            <span class="text-primary font-mono font-bold text-[10px]">deg</span>
          </div>
          ...
          <div class="w-full pt-1.5 border-t border-border flex items-center justify-between text-[11px] text-muted-foreground">
            <span>Angle: <b class="text-foreground font-mono">{{ windDir.toFixed(0) }}°</b></span>
            <span class="text-[10px]">Port Bow</span>
          </div>
        </div>
        ...
        <div class="flex flex-col items-center justify-between rounded-lg border bg-card/60 p-3 h-full shadow-xs">
          <div class="w-full flex items-center justify-between text-xs text-muted-foreground">
            <span class="font-medium uppercase text-[10px]">Wave Height</span>
            <span class="text-primary font-mono font-bold text-[10px]">m</span>
          </div>
          ...
          <div class="relative flex items-center justify-center my-1">
            ...
            <div class="absolute bottom-1 flex flex-col items-center">
              <span class="font-mono text-lg font-bold text-foreground tabular-nums">{{ waveHeight.toFixed(1) }}</span>
              <span class="text-[9px] text-muted-foreground uppercase tracking-wider">METERS</span>
            </div>
          </div>

          <div class="w-full pt-1.5 border-t border-border flex items-center justify-between text-[11px] text-muted-foreground">
            <span>Swell: 1.9m</span>
            <span class="text-[10px]">Slight</span>
          </div>
        </div>
        ...
        <div class="flex flex-col items-center justify-between rounded-lg border bg-card/60 p-3 h-full shadow-xs">
          <div class="w-full flex items-center justify-between text-xs text-muted-foreground">
            <span class="font-medium uppercase text-[10px]">Mean Draft</span>
            <span class="text-primary font-mono font-bold text-[10px]">m</span>
          </div>
          ...
          <div class="relative flex items-center justify-center my-1">
            ...
            <div class="absolute bottom-1 flex flex-col items-center">
              <span class="font-mono text-lg font-bold text-foreground tabular-nums">{{ meanDraft.toFixed(1) }}</span>
              <span class="text-[9px] text-muted-foreground uppercase tracking-wider">METERS</span>
            </div>
          </div>
          ...
          <div class="w-full pt-1.5 border-t border-border flex items-center justify-between text-[11px] text-muted-foreground">
            <span>Trim: 0.2m</span>
            <span class="text-[10px]">Even</span>
          </div>
        </div>
      </div>
    </CardContent>
